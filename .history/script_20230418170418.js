...
function update_add(){
  ...
  var text = document.getElementById("total-per-person").innerText.replace("₹", "");
  if(fin_val1!=0 && document.getElementById("total-per-person").innerHTML!="₹0.00" && document.getElementById("tip-per-person").innerHTML!="₹0.00"){
    document.getElementById("total-per-person").innerHTML=document.getElementById("total-per-person").innerHTML/fin_val1; 
    document.getElementById("tip-per-person").innerHTML=document.getElementById("tip-per-person").innerHTML/fin_val1; 
  }
}
function update_sub(){
  get_value_of_people();
